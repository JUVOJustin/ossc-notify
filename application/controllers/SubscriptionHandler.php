<?php
    ...
    class SubscriptionHandler extends CI_Controller {
        ...
        private function sendVerification() {
            ...
            $this->email->message('<h2>Hallo,</h2>du hast dich in den Verteiler für Benachrichtigungen zu neuen Klausuren eingetragen.<br>Bitte bestätige deine Anmeldung hier: <b>'. base_url() .'?uid='.$this->user_id.'&v=1</b>');
            $this->email->send();
        }
